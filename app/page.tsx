...
export default function Home() {
  ...
  return (
    ...
    {/* Stylized Welcome Section with background image and overlay */}
    <div className="relative h-screen flex flex-col items-center justify-center text-center" style={{ backgroundImage: "url('/whitemarble.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
      {/* Overlay */}
      ...
      <div className="relative z-20 px-6 py-8">
        ...
        <p className="mt-4 text-lg md:text-xl m-2 text-gray-300 drop-shadow">
